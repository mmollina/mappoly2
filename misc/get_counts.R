# get_counts_single_parent <- function(ploidy,
#                                      gen.par.mk1,
#                                      gen.par.mk2,
#                                      gen.prog.mk1,
#                                      gen.prog.mk2) {
#   res <- .Call("get_counts_single_parent_cpp",
#                as.numeric(ploidy),
#                as.numeric(gen.par.mk1),
#                as.numeric(gen.par.mk2),
#                as.numeric(gen.prog.mk1),
#                as.numeric(gen.prog.mk2),
#                as.numeric(rep(0, ploidy + 1)),
#                PACKAGE = "mappoly")
#   return(res[[6]])
# }

get_counts_single_parent_cpp <- mappoly:::get_counts_single_parent
...
save(full_counts, file = "./R/sysdata.rda", compress = "xz")
